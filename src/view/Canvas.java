...
public class Canvas
{
	...
	public static Canvas getCanvas()
	{
		if(canvasSingleton == null) {
			canvasSingleton = new Canvas("Pac-Man", WIDTH, HEIGHT,
					Color.white);
		}
	...
	{
		this.isAIdriven = true;
		frame = new JFrame();
		this.jmb = new JMenuBar();
	    this.menu = new JMenu("Control");
	    this.manual = new JMenuItem("Manual");
	    this.manual.addActionListener(this::manualPressed);
	    this.ai = new JMenuItem("AI");
	    this.ai.addActionListener(this::aiPressed);
	    this.menu.add(this.manual); 
	    this.menu.add(this.ai); 
	    this.jmb.add(menu);
	    frame.setJMenuBar(this.jmb);
	...
	public void manualPressed(ActionEvent e) {
		this.isAIdriven = false;
	}
	
	public void aiPressed(ActionEvent e) {
		this.isAIdriven = true;
	}
